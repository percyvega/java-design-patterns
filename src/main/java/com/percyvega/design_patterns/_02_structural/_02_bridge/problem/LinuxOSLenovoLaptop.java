 ...
 */
public class LinuxOSLenovoLaptop extends LinuxOS implements LenovoLaptop {

    private final static Logger logger = LoggerFactory.getLogger(LinuxOSLenovoLaptop.class);
